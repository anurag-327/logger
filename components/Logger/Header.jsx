...
const Header = () => {
  ...
  return (
    <nav className="sticky top-0 flex justify-between w-full px-2 py-3 bg-gray-400 sm:px-10 md:px-10 lg:px-40 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10">
      <div>
